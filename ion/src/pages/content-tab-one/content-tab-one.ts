...
import { ContentTabOneService, DisplayService, SocialMedia, SocialService, DataService } from '../../providers';
import { ContentTabOneItem, ContentComment } from "../../interfaces/common-interfaces";
...
/*
  Generated class for the ContentTabOne page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
    selector: 'page-content-tab-one',
    templateUrl: 'content-tab-one.html'
})
export class ContentTabOne {
    ...
    public itemData: ContentTabOneItem = new ContentTabOneItem();
    ...
    constructor(
        ...
        public service: ContentTabOneService,
