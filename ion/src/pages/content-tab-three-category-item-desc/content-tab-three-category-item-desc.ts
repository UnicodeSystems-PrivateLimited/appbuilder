...
import { ContentTabThreeService, DisplayService, SocialMedia, SocialService, DataService } from '../../providers';
import { ContentTabThreeCategoryItemData, ContentComment } from "../../interfaces/common-interfaces";
...
/*
  Generated class for the ContentTabThreeCategoryItemDesc page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
    selector: 'page-content-tab-three-category-item-desc',
    templateUrl: 'content-tab-three-category-item-desc.html'
})
export class ContentTabThreeCategoryItemDesc {

    public itemId: number;
    public tabId: number;
    public title: string;
    public itemData: ContentTabThreeCategoryItemData = new ContentTabThreeCategoryItemData();
    ...
    constructor(
        ...
        this.getCategoryItemData();
    }

    public getCategoryItemData(): void {
        this.loader = true;
        this.service.getCategoryItemData(this.itemId).subscribe(res => {
            this.loader = false;
            if (res.success) {
