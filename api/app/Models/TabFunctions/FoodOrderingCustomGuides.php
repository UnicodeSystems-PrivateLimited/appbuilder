...
class FoodOrderingCustomGuides extends Model
{

    protected $table = 'tp_func_food_emails_custom_guides';
    protected $guarded = ['id'];

    const TABLE = 'tp_func_food_emails_custom_guides';  

    public static function getFoodCustomeGuides(int $tab_id) {
    ...
    public static function savecustomGuides($id, $shipping_method, $pickup_method, $digital_method, $card, $cash, $order_items_list_template) {
        DB::table('tp_func_food_emails_custom_guides')->where('id', $id)->update([
