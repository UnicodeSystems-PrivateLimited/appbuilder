...
class Content2Comments extends Model {

    protected $table = 'tp_func_content_tab_2_comment';
    protected $guarded = ['id'];
    const TABLE = 'tp_func_content_tab_2_comment';

    /**
     * get comments for content tab 2
     */
