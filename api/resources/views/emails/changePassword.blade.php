...
<html lang="en">
  ...
  <body>
    <div style="max-width:600px; font-family:arial; margin:20px auto; border:1px solid #ededed; font-size:14px;">
        ...
        <div style="display: block; padding: 20px; text-align: lrft; font-size:16px; color: #2E5075; background: #f8f8f8;">
            <h1>Dear {{$name}},</h1>
            <!--<p><img src="resources/assets/images/email/logo.png"></p>-->
            <p>Your Tappit account password has been changed successfully .</p>
        </div>
