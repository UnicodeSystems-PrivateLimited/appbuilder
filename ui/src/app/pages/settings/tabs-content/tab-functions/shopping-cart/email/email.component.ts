...
import {
    ShoppingCartEmailCustomerConfirmation, ShoppingCartEmailAdminReceipt, ShoppingCartCustomGuides
} from "../../../../../../theme/interfaces/common-interfaces";

@Component({
    selector: 'shopping-cart-email',
...
export class Email implements OnInit {
    ...
    @Input() emailCustomerConfirmation: ShoppingCartEmailCustomerConfirmation;
    @Input() emailAdminReceipt: ShoppingCartEmailAdminReceipt;
    @Input() emailCustomGuides: ShoppingCartCustomGuides;
    ...
    //public emailCustomerConfirmation: ShoppingCartEmailCustomerConfirmation;
    ...
    public onSaveClickEmailCart(): void {
        ...
        this.service.saveEmailCart(data).subscribe(res => {console.log(res);
            if (res.success) {
