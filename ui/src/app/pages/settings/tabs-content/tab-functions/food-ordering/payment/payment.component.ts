...
@Component({
    selector: 'food-ordering-payment',
...
export class Payment implements OnInit {
    ...
    public ngOnInit(): void {
        this.taxAmount = new FoodOrderingPaymentTaxDetails();
        this.taxAmount.tab_id = this.payment.tab_id;
    ...
    public onTaxEditClick(tax: FoodOrderingPaymentTaxDetails): void {
