...
export class ButtonsComponent {
    ...
    public onBackgroundImgUploadClick(): void {
        ...
        this.service.uploadButtonBackgroundImg(this.backgroundImg, this.appId).subscribe(res => {
            ...
            if (res.success) {
                ...
                this.service.homeScreenSettings.buttons.background_img = res.createdImgId;
            } else {
    ...
    public onBackgroundImgClick(id: number): void {
        this.noImage = false;
        this.service.homeScreenSettings.buttons.background_img = id;
    }
    ...
    public onNoImage(): void {
        this.noImage = true;
        this.service.homeScreenSettings.buttons.background_img = null;
    }
}
