...
@Component({
    ...
    providers: [BaSidebarService, PageService],
    directives: [BaSlimScroll, Dialog]
})
export class BaSidebar {
    ...
    constructor(private _elementRef: ElementRef,
        ...
        if (GridDataService.isCustomerPortal) {
            this.menuItems = this._sidebarService.getCustomerPortalMenuItems();
        } else {
